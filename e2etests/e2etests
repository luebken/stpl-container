...
# TODO discuss:
echo "Example 5: Vertx Traderrecommendations"
printf "Similarity: "
curl -s -X GET -d @e2etests/example-6-vertx-burr-traderecommendations-effective-pom.xml localhost:8088/analysis | jq .Analysis.Recommendation.Similarity
curl -s -X GET -d @e2etests/example-6-vertx-burr-traderecommendations-effective-pom.xml localhost:8088/analysis | jq .Analysis.Recommendation.RecommendationItems